...
if [ $SO == 'debian' ]; then
	...
	echo "deb http://ppa.launchpad.net/webupd8team/java/ubuntu $DISTRO_NAME main" | tee /etc/apt/sources.list.d/webupd8team-java.list
	echo "deb-src http://ppa.launchpad.net/webupd8team/java/ubuntu $DISTRO_NAME main" | tee -a /etc/apt/sources.list.d/webupd8team-java.list
